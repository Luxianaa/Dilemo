...
export default function GameQuiz() {
  ...
  // Preguntas de Logo Quiz / Cultura General
  const questions = [
    { text: "El logo de Apple tiene una manzana mordida.", answer: true },
    { text: "El logo de McDonald's son dos arcos amarillos formando una 'W'.", answer: false },
    { text: "El logo de Nike se llama 'Swoosh'.", answer: true },
    { text: "Spotify usa un círculo verde con ondas de audio.", answer: true },
    { text: "El logo de Twitter es un pájaro rojo.", answer: false },
    { text: "Instagram usa un ícono de cámara dentro de un cuadrado.", answer: true },
    { text: "YouTube tiene un botón de play dentro de un rectángulo rojo.", answer: true },
    { text: "Facebook usa la letra 'f' en color azul.", answer: true },
    { text: "TikTok usa colores cyan, magenta y negro.", answer: true },
    { text: "Discord tiene un logo con forma de controlador de juegos.", answer: false }
  ];
